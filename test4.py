    ...
    with zipfile.ZipFile(output_zip, "w") as zf:
        ...
        for idx, row in df.iterrows():
            try:
                ...
                # Cari placeholder [short_link] dan ganti dengan hyperlink aktif biru
                for p in doc.paragraphs:
            ...
            status_text.text(f"Sedang memproses surat {idx + 1} dari {total}")
...
def page_generate():
    ...
    if template_file and data_file:
        ...
        if st.session_state.show_preview and selected_name:
            ...
            tpl = DocxTemplate(template_file)
            # Render langsung short_link untuk preview tanpa placeholder
            ...
            # Preview interaktif dengan highlight nama & short_link
